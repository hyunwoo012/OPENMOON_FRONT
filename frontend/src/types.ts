...
export type CommitmentStatus = "confirmed" | "unconfirmed" | "unclear";
...
export type QuotationStorageMode = "existing" | "department" | "person" | "separate";

export interface QuotationStorageCandidate {
  mode: QuotationStorageMode;
  filename: string;
  file_type: string;
  exists: boolean;
  path: string;
...
export interface AgentEvidenceLocation {
  sheet?: string | null;
  cell?: string | null;
}
...
export interface AgentEvidence {
  ...
  count?: number;
  preview?: string[];
  locations?: AgentEvidenceLocation[];
...
export interface OpenPriceSourceResult {
  opened: boolean;
  file_path: string;
  sheet?: string | null;
  cell?: string | null;
  mode?: "excel_com" | "default_viewer" | "file_explorer" | string;
